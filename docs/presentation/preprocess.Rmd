...
clouds_q6$Everyone <- clouds$Q6_definition
...
clouds_q19 <- append(clouds_q19_q3, clouds_q19_q4)
clouds_q19$Everyone <- clouds$Q19_reason_for_rep
saveRDS(clouds_q19, file = "data/clouds_q19.rds")
```
...
q7 <- append(q7_q3, q7_q4)
q7$Everyone <- q7_to_likert()
saveRDS(q7, file = "data/q7.rds")
```
